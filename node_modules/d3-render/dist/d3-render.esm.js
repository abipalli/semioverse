import { select, namespace, selection } from 'd3-selection';
...
function renderSelection(selection, data, level) {
  ...
  data.filter(function (d) {
    ...
    return enter.append(function (d) {
      ...
      var namespace$1 = getNamespace(d.append);
      ...
      namespace(namespace$1).space, d.append);
    }).each(function (d) {
      var element = select(this); // Hook into things like selection.call(xAxis)
...
function exitTransition(d) {
  select(this).call(function (selection) {
...
//# sourceMappingURL=d3-render.esm.js.map
